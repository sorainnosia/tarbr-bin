    ...
    public struct CompressionMethod : IEquatable<CompressionMethod>
    {
        ...
        public override string ToString()
        {
            switch (~mSignature)
            {
                ...
                case kDelta: return "Delta";
                case kLZMA2: return "LZMA2";
                case kLZMA: return "LZMA";
                case kPPMD: return "PPMD";
                case kBCJ: return "BCJ";
                case kBCJ2: return "BCJ2";
                case kDeflate: return "Deflate";
                case kBZip2: return "BZip2";
                case kAES: return "AES";
